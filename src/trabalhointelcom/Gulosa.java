...
public class Gulosa {
    ...
    private static final Logger LOG = Logger.getLogger(Gulosa.class.getName());
    ...
    private void calcula_rota( int ponto_atual, int cont_rota){
        double[][] custos_do_ponto_atual = 
        calcula_custos(ponto_atual);
        
        //Verifica se este ponto já está incluído na rota
        int i=0;
        ...
        //Chamada recursiva até preencher toda a rota
